...
**Figma:** [секция ↪ input-combi 5:15 → набор 34:36539](https://www.figma.com/design/470rar5EfRm4n14vHMXbpc/%F0%9F%92%A0-arrow-%E2%86%AA-components?node-id=34-36539)
...
Единственное отличие от Default — **фон покоя**: `surface-bright` (белый) вместо `secondary-container-core` (серого). Рамка, текст, метка и остальные состояния совпадают до значения. Фокус расходится фоном: у Default он уходит в `primary-container-base`, у Light остаётся белым — своей ячейки `bg-focus` у варианта нет.
