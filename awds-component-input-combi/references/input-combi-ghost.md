...
**Figma:** [секция ↪ input-combi 5:15 → набор 34:36794](https://www.figma.com/design/470rar5EfRm4n14vHMXbpc/%F0%9F%92%A0-arrow-%E2%86%AA-components?node-id=34-36794)
...
Фон и рамка **прозрачны во всех состояниях покоя**. Поле опознаётся только по метке и по кольцу при фокусе.
