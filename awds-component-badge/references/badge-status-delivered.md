...
Стадия заказа: доставлен.

**Figma:** [Badge / State Delivered](https://www.figma.com/design/UCYhMA1JeNUNuVGsxUEne7/%F0%9F%92%A0-Comp-%E2%86%AA-%C2%B9-Elemets?node-id=2093-5070)
...
```html
<!-- текст -->
<span class="badge badge-status-delivered badge--400">
  <span class="badge__label">Доставлен</span>
</span>
...
<span class="badge badge-status-delivered badge--200">
  <svg class="badge__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 8h.01M11 12h1v4h1"/></svg>
</span>
```
...
|---|---|---|
| bg | `--awds-state-badge-status-delivered-bg-rest` | `secondary-core` |
| chroma (дрейф градиента) | `--awds-state-badge-status-delivered-chroma-rest` | `secondary-chroma` |
| border | `--awds-state-badge-status-delivered-border-rest` | `secondary-core` |
| color (текст/иконки) | `--awds-state-badge-status-delivered-color-rest` | `secondary-on-dim` |
