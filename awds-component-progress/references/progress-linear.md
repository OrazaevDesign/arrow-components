...
**Полоса вырастает из нуля,** а не появляется готовым отрезком. В material-web первый
кадр — сразу `scaleX(0.08)`, то есть у левого края мгновенно возникает полоса длиной 8%:
на глаз это читается как «стартовала с 10%», а не с нуля. Здесь ширина растёт от 0 за то
время, пока полоса стоит на месте, — движение не меняется, появление перестаёт быть
скачком. Второе отклонение от оригинала, тоже осознанное.
